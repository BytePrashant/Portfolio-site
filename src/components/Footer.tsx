export function Footer() {
  ...
  return (
    <footer className="relative flex flex-col py-10 md:py-20 bg-gray-800 font-custom1">
      <div className="container px-6 mx-auto md:w-3/4">
        <div className="content flex flex-col text-center gap-4 md:flex-row md:justify-between md:items-center">
          <h3 className="text-lg font-bold text-white">
            Copyright © {currentYear}. All rights are reserved
          </h3>
          <div className="flex gap-4 mt-4 justify-center text-white md:mt-0">
            <a
              aria-label="linkedin"
              target="_blank"
              rel="noreferrer"
